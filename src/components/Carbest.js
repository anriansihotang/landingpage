...
const Cardbest = () => {
  return (
    <div className="flex w-full  flex-col md:flex-row self-auto md:self-end">
      <div className="card rounded-2xl bg-white shadow-card md:mr-5">
        <div className="px-8 py-6">
          <h3 className="text-pink text-center text-4xl pt-3.5 pb-4">
            CLIMATE CONTROLLER PUNOS
          </h3>
          <p className="m-auto text-justify text-3xl">
      ...
      <div className="card rounded-2xl bg-white	shadow-card">
        <div className="px-8 py-6">
          <h3 className="text-pink text-center text-4xl pt-3.5 pb-14">
            COOLING PAD PUNOS
          </h3>
          <p className="m-auto text-justify px-4 pb-3 text-3xl">
